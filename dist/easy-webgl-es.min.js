...
var lineVertexShader = function () {
    return "\n    attribute vec4 a_position;\n    void main() {\n      gl_Position = a_position;\n    }\n  ";
};
var lineFragmentShader = function (r, g, b) {
...
var EwContext = (function () {
    ...
    EwContext.prototype.lineTo = function () {
        createShaderProgram(this.gl, lineVertexShader(), lineFragmentShader(this.strokeRgb[0], this.strokeRgb[1], this.strokeRgb[2]));
    };
...
export { EwContext, ShaderType, WARN_LEVEL, createContext, createShaderProgram, isWebGl2, lineFragmentShader, lineVertexShader, loadShader, setRectangle, toRgb, warn };
