var EW = (function (exports) {
  ...
  const createShaderProgram = (gl, vsSource, fsSource) => {
      const vertexShader = loadShader(gl, exports.ShaderType.VERTEX_SHADER, vsSource);
      const fragmentShader = loadShader(gl, exports.ShaderType.FRAGMENT_SHADER, fsSource);
  ...
  ***************************************************************************** */
  ...
  class EwContext {
      ...
      stroke() {
          ...
          if (this.lineWidth === 1) {
              const shaderProgram = createShaderProgram(this.gl, pointsVertexShader(), pointsFragmentShader(1.0, 0.5, 0.0));
              initBuffers(this.gl, renderPoints);
              const vertexPosition = this.gl.getAttribLocation(shaderProgram, 'a_position');
  ...
  exports.imageFragmentShader_A = imageFragmentShader_A;
  exports.imagePointShader_A = imagePointShader_A;
  exports.initBuffers = initBuffers;
  exports.injectAttribute2D = injectAttribute2D;
