var EW = (function (exports) {
  ...
  const injectAttribute2D = (gl, data) => {
  ...
  ***************************************************************************** */
  ...
  class EwContext {
      ...
      _drawImageB(image, dx, dy, dWidth, dHeight) {
          return __awaiter(this, void 0, void 0, function* () {
              const imgStatus = this._loadAndCreateTexture(image, this.gl).then((tx) => {
      ...
      stroke() {
          ...
          for (let i = 0, l = this._pathArray.length; i < l; i++) {
              for (let j = 1, m = this._pathArray[i].length; j < m; j++) {
                  ...
                  renderPoints.push(beginPoint.x, beginPoint.y, 1, 1, endPoint.x, endPoint.y, 1, 1);
              }
          }
